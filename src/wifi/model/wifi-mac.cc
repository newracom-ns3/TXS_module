    ...
    static TypeId tid =
        TypeId("ns3::WifiMac")
            ...
            .AddAttribute(
                ...
                MakeUintegerChecker<uint16_t>())
            .AddAttribute("FrameExchangeManager",
                          "FrameExchangeManager",
                          PointerValue(),
                          MakePointerAccessor(&WifiMac::GetFrameExchangeManagerZero),
                          MakePointerChecker<FrameExchangeManager>())
...
// @cm.lee
Ptr<FrameExchangeManager>
WifiMac::GetFrameExchangeManagerZero() const
{
    return GetLink(0).feManager;
}
