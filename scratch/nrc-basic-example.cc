...
NS_LOG_COMPONENT_DEFINE("nrc-basic-example");
...
main(int argc, char* argv[])
{
    ...
    // Network setting
    bool isEhtNetwork{false};
    bool udp{true};
    bool downlink{true};
    bool enableUlOfdma{false}; // uora-example enable
    ...
    for (int mcs = minMcs; mcs <= maxMcs; mcs++)
    {
             ...
             channelWidth++) // MHz
        {
            ...
            // @cm.lee
            std::cout << "AP IP address: " << apNodeInterface.GetAddress(0) << std::endl;
            ...
            if (udp)
            {
                ...
                for (std::size_t i = 0; i < nStations; i++)
                {
                    ...
                    if (packetQosSupport)
                    {
                        ...
                        // 1/number of STA --> Total same with AP
                        ...
                        staClient.SetAttribute(
                            "DataRate",
                            StringValue("25000kb/s")); // Maybe we need to make this slow
            ...
            */
            ...
            std::string tracePath_tx_sent;
            std::string tracePath_rx;

            probeType = "ns3::Ipv4PacketProbe";

            tracePath_tx = "/NodeList/*/$ns3::Ipv4L3Protocol/Tx";
            tracePath_tx_sent = "/NodeList/*/$ns3::Ipv4L3Protocol/SendOutgoing";
            ...
            std::string headlineTx = "Scenario Basic: Tx packet bytes";
            std::string headlineRx = "Scenario Basic: Rx packet bytes";
            ...
            std::string filePathTx = "newracom-data/Basic/tx-packet-" + std::to_string(simTrial);
            std::string filePathRx = "newracom-data/Basic/rx-packet-" + std::to_string(simTrial);
            ...
            fileHelperTx.WriteProbe("ns3::PacketProbe", tracePath_tx_sent, "OutputBytes");
