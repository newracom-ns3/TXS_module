        ...
        for (int channelWidth = frequency == 2.4 ? 20 : 80; channelWidth <= maxChannelWidth;) // MHz
        {
            ...
            for (int gi = 1600; gi >= 1600;) // Nanoseconds
            {
                ...
                */
                ...
                std::string tracePath_tx, tracePath_rx, tracePath_mu_rts;

                // probeType = "ns3::BooleanProbe";
                ...
                std::string headline = " MU-RTS sending Timelog";
                fileHelper.SetHeading(headline);

                // Configure the file to be written, and the formatting of output data.
                std::string filePath = "newracom-data/data/muRts-" + std::to_string(simTrial);
                simTrial++;
                std::cout << filePath << "\n";
